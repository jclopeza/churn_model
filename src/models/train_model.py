...
def train_and_evaluate(config_path):
    ...
    train_x, train_y = get_features_and_target(train, target)
    test_x, test_y = get_features_and_target(test, target)
    ...
    with mlflow.start_run(run_name=mlflow_config["run_name"]) as mlops_run:
        ...
        accuracy, precision, recall, f1score = accuracy_measures(test_y, y_pred, 'weighted')
